  ...
  return (
    <div dir="rtl" className="relative grid min-h-screen place-items-center overflow-hidden bg-zinc-950 p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mt-4 rounded-lg border border-border/50 bg-muted/30 p-3 text-xs text-muted-foreground" dir="rtl">
          <div className="mb-1 font-semibold text-foreground">بيانات الدخول التجريبية:</div>
          <div className="space-y-0.5">
            <div>• المالك: <code className="text-primary">Momen Hani</code> / <code className="text-primary">admin123</code></div>
            <div>• أدمن: <code className="text-primary">Admin_Hesham</code> / <code className="text-primary">admin123</code></div>
            <div>• مشرف: <code className="text-primary">Mod_Karim</code> / <code className="text-primary">mod123</code></div>
          </div>
        </div>
